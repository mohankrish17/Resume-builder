...
document.querySelector("#proAddButton").addEventListener("click",function (){

    let newProNode1=document.createElement('textarea');
    newProNode1.classList.add('form-control');
    newProNode1.classList.add('proField');
    newProNode1.classList.add("mt-3");
    //newNode1.setAttribute("rows",3);
    newProNode1.setAttribute('placeholder',"Enter project details");

    let proOb=document.querySelector("#pro");
    let proAddButtonOb=document.querySelector("div.proAddButton");
    
    proOb.insertBefore(newProNode1,proAddButtonOb);
});
...
document.querySelector("a.generateCv").addEventListener("click",function(){
   ...
   /* let links=document.getElementsByClassName("linkField");
    ...
    /*objective*/
    let about=document.querySelector("textarea.abField").value;
     document.querySelector("#aboutT").innerHTML=about;
     /*objective*/
   ...
   /*work-exp*/
    ...
    /*Acadamic-qualifications*/
      ...
      for(let p of pro)
      {
         str4pro=str4pro+`<li>${p.value}</li>`;
      }
      document.getElementById("proT").innerHTML=str4pro;
     /*Projects*/
